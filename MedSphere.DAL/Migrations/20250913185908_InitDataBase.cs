        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShelfLifeMonths = table.Column<int>(type: "int", nullable: false),
                    ...
                    BarcodeOrQRCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineIngredients", x => new { x.MedicineId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_MedicineIngredients_Ingredients_IngredientId",
